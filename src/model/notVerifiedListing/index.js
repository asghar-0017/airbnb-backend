...
const notVerifiedListingSchema = new mongoose.Schema({
  hostId: {
...
notVerifiedListingSchema.virtual('confirmedBookings', {
  ref: 'ConfirmedBooking',
  localField: '_id',
  foreignField: 'listingId',
});

export default mongoose.model('notVerifiedListing', notVerifiedListingSchema);
